...
def write_readme(devein_params, anchor_params, reg_params, gbb_params, 
                 deformation_sigma, niter_d, niter_a, path_output, name_output):
    """
    ...
    Inputs.
        ...
        *deformation_sigma (float): gaussian filter for deformation field
        *niter_d (int): number of deveining iterations.
        *niter_a (int): number of anchoring iterations.
