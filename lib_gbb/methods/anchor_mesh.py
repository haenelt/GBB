def anchor_mesh(vtx, fac, adjm, anchor, n_neighbor=20, smooth_iter=0):
    """
    This function finds loads a list of control points and shifts a mesh with its local neighborhood
    to match these control points. Control points are assumed to be in ras coordinates. Optionally, 
    the output mesh can be smoothed.    
    Inputs.
        *vtx: array of vertex points.
        *fac: array of corresponding faces.
        *anchor: list of control points.
    ...
    Outputs:
        ...
        *ind_control: indices of closest vertices to control points.
