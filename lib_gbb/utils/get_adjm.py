def get_adjm(input_surf):
    """
    This function computes a sparse adjacency matrix from a surface mesh in freesurfer format. The 
    matrix has the size (nvertex,nvertex). Each matrix entry with value 1 stands for an edge of the 
    surface mesh.
    Inputs:
