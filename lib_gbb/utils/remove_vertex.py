def remove_vertex(vtx, fac, ind_keep):
    """
    This function removes vertices from an array of vertex points and updates the corresponding 
    face array.
    Inputs:
        *vtx: array of vertices.
        *fac: array of faces.
        *ind_keep: index list of vertices to keep.
    Outputs:
        *vtx: remaining vertices.
        *fac: remaining faces.
